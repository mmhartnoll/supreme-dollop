...
namespace MindSculptor.App.AppDataContext.Schemas.Mtga.Tables
{
    ...
    {
        private ProfileInventoriesTable(DatabaseContext databaseContext) : base(databaseContext, "Mtga", "ProfileInventories")
        {
        }

        internal static ProfileInventoriesTable Create(DatabaseContext databaseContext)
        {
            return new ProfileInventoriesTable(databaseContext);
        }
        ...
        {
            return DatabaseContext.Execute(command => NewRecord(command, profileId, mythicRareWildcardCount, rareWildcardCount, uncommonWildcardCount, commonWildcardCount, goldCount, gemCount, vaultProgress));
        }
        ...
        {
            return await DatabaseContext.ExecuteAsync((command, cancellationToken) => NewRecordAsync(command, profileId, mythicRareWildcardCount, rareWildcardCount, uncommonWildcardCount, commonWildcardCount, goldCount, gemCount, vaultProgress, cancellationToken), cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return DatabaseContext.Execute(command => NewRecord(command, profileRecord.Id, mythicRareWildcardCount, rareWildcardCount, uncommonWildcardCount, commonWildcardCount, goldCount, gemCount, vaultProgress));
        }
        ...
        {
            return await DatabaseContext.ExecuteAsync((command, cancellationToken) => NewRecordAsync(command, profileRecord.Id, mythicRareWildcardCount, rareWildcardCount, uncommonWildcardCount, commonWildcardCount, goldCount, gemCount, vaultProgress, cancellationToken), cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            var newRecord = ProfileInventoryRecord.Create(DatabaseContext, this, profileId, mythicRareWildcardCount, rareWildcardCount, uncommonWildcardCount, commonWildcardCount, goldCount, gemCount, vaultProgress);
        ...
        protected override ProfileInventoryRecord MapRecordFromDataReader(DbDataReader dbDataReader)
        {
            ...
            return ProfileInventoryRecord.Create(DatabaseContext, this, profileId, mythicRareWildcardCount, rareWildcardCount, uncommonWildcardCount, commonWildcardCount, goldCount, gemCount, vaultProgress);
        }
    }
}