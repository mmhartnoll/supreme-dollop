...
{
    public class FaceHasSuperTypes : RecordDefinition
    {
        ...
        public static readonly IdField SuperTypeId = new IdField.Definition
        {
            MappedField = SuperTypes.Id,
            IsReadOnly = true
        };
        ...
        {
            Fields = FieldReference.List(FaceId, SuperTypeId)
        };
