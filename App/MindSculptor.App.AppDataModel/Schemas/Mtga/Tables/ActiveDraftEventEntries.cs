...
{
    public class ActiveDraftEventEntries : RecordDefinition
    {
        public override Schema Schema => MindSculptorDataModel.Mtga;
        public override string SingularName => "ActiveDraftEventEntry";
        ...
        {
            Fields = FieldReference.List(DraftEventEntryId, DraftEventId, ProfileId)
        };

        public static ForeignKey FK1 = new ForeignKey.Definition
        {
            Fields = FieldReference.List(DraftEventEntryId, DraftEventId, ProfileId),
            ReferencedKey = DraftEventEntries.UQ
        };
