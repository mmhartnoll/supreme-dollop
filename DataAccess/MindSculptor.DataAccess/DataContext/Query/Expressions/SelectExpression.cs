...
namespace MindSculptor.DataAccess.DataContext.Query.Expressions
{
    ...
    {
        private readonly IDataContextQueryable queryable;
        private readonly LogicalExpression logicalExpression;
        private readonly List<OrderByClause> orderByClauses;

        private SelectExpression(IDataContextQueryable queryable)
        {
            this.queryable = queryable;
            logicalExpression = LogicalAndExpression.CreateEmpty();
            orderByClauses = new List<OrderByClause>();
        }

        public static SelectExpression Create(IDataContextQueryable queryable)
