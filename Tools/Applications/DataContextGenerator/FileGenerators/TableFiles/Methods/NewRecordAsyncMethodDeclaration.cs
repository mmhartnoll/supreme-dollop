...
{
    internal class NewRecordAsyncMethodDeclaration : NewRecordMethodDeclarationBase
    {
        private NewRecordAsyncMethodDeclaration(RecordDefinition recordDefinition)
            : base($"Task<{recordDefinition.RecordName}>", "NewRecordAsync", MemberModifiers.Async, recordDefinition)
        { }

        public static NewRecordAsyncMethodDeclaration Create(RecordDefinition recordDefinition)
            => new NewRecordAsyncMethodDeclaration(recordDefinition);
